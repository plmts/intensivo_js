...
function desenharProdutoCarrinho(idProduto){
  ...
  const cartaoProdutoCarrinho = `<button class="text-red-500 hover:bg-red-400 hover:text-slate-200 rounded-full" id="fechar-carrinho"><i class="fa-solid fa-xmark"></i></button>
